...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'py-2 bg-github-darker/95 backdrop-blur-md shadow-md mx-3 md:mx-6 mt-2 rounded-md' : 'py-4 bg-transparent'}`}>
